...
cat > "/data/adb/service.d/uninstall_SurfingTile.sh" << 'EOF'
#!/system/bin/sh
...
rm -f "/data/adb/service.d/uninstall_SurfingTile.sh"
EOF

chmod +x "/data/adb/service.d/uninstall_SurfingTile.sh"